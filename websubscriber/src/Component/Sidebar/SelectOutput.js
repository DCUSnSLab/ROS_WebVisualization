...
//
// export default function SelectOutput({topic, onSelect, initialPanel = ""}) {
...
//         const next = selectedPanel === value ? "" : value;
//         setSelectedPanel(next);
//         onSelect && onSelect({topic, panel: next});
//     };
//
//         return (
...
//                                 backgroundColor:
//                                     selectedPanel === value ? "#1B1F3B" : "white",
//                                 color: selectedPanel === value ? "white" : "black",
//                                 cursor: "pointer",
//                                 fontWeight: "bold",
//                             }}
//                             title={`${topic} → ${label}`}
